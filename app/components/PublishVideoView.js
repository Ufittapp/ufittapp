    import React from 'react'
     ...
     class PublishVideoView extends React.Component{
              ...
              return (
                ...
                <Container>
                  <Header style={styles.headerBg}>
                      ...
                      <Right>
                          <Button transparent onPress={() => {this.videoUpload(this.state.path, this.state.description, this.state.challenge)}}>
...
export default connect()(PublishVideoView)
